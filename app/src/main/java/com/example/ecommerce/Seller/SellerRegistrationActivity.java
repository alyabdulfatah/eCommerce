...
public class SellerRegistrationActivity extends AppCompatActivity
{
    ...
    private Button sellerLoginBegin, sellerRegister;
    ...
    private void registerSeller()
    {
                            ...
                            if (task.isSuccessful())
                            {
                                ...
                                rootRef.child("Sellers").child(sid).updateChildren(sellerMap)
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            {
                                                loadingBar.dismiss();
                                                Toast.makeText(SellerRegistrationActivity.this,"You are Register Successfully.",Toast.LENGTH_LONG).show();
        ...
        {
            Toast.makeText(SellerRegistrationActivity.this,"Please Complete Registration Form.",Toast.LENGTH_LONG).show();
        }
